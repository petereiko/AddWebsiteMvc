        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BallotStatus = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotePrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VotePrices_Elections_ElectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CastTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ballots_Voters_VoterId",
                        column: x => x.VoterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidateCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d"), "aae6c525-231e-46c3-aebb-86679ec770d9", new DateTime(2026, 1, 14, 15, 28, 28, 850, DateTimeKind.Utc).AddTicks(8424), "Administrator role with full access", "Admin", "ADMIN", null },
                    { new Guid("2b3c4d5e-6f7a-8b9c-0d1e-2f3a4b5c6d7e"), "6286f63e-54d6-4369-9510-b58a8bf7ac43", new DateTime(2026, 1, 14, 15, 28, 28, 850, DateTimeKind.Utc).AddTicks(8490), "Standard user role", "User", "USER", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateCategories_CategoryId",
                table: "CandidateCategories",
                column: "CategoryId");
